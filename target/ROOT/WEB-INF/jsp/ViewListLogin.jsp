...
<body>
   ...
   <h1 class="text-info">List your figures</h1>
    ...
    <form action="${pageContext.request.contextPath}/priv/form" method="get">
      ...
      <form action="${pageContext.request.contextPath}/priv/viewAllFigures" method="get">
            <input type="submit" class="btn btn-info btn-md" value="View all figures" />
      </form>
   ...
   <c:forEach var = "figure" items="${listFigures}">
       ...
       <p class="card-text"> Creation Date: ${figure.date} </p>
        ...
        <a href="viewFigure?name=${figure.name}&user_own=${figure.username_own}" class="btn btn-primary">View</a></td>
